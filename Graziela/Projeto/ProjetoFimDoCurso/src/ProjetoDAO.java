...
public class ProjetoDAO {
	...
	public static void inserirUsuario(Connection conexao, String nomezinho, String endereco, int perfil, String usuario, String senha) throws SQLException {
	...
	public static void inserirLivro(Connection conexao, String nome, String autos, int anoEdicao) throws SQLException {
		StringBuilder sql = new StringBuilder();
		...
		preparedStatement.setString(2, autos);
