...
public class Pesquisa {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= qtdFuncionarios; i++) {
			salario = Double.parseDouble(JOptionPane.showInputDialog("Digite o salário do funcionario: " + i + "."));
		...
		JOptionPane.showMessageDialog(null,
				"A média dos salário é: " + mediaSalario + "\nA média da quantidade de dependentes é: "
						+ mediaQtdDependentes + "\nO maior salario é: " + maiorSalario + "\nO menor salário é: "
						+ menorSalario + "\nO percentual de pessoa com salário menor ou igual a R$1000,00 é: "
